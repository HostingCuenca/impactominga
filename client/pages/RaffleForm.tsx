...
import { Save, X, Calendar, DollarSign, Ticket, Image as ImageIcon } from "lucide-react";
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.message || "Error al crear sorteo");
      }
    } catch (err) {
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 font-raleway">
              Complete el formulario para crear un nuevo sorteo
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1 font-raleway">
                    Los borradores no serán visibles al público
                  </p>
                </div>
