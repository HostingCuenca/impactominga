    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="pt-32 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-6 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="space-y-3 bg-gray-50 rounded-lg p-6">
              ...
              <div className="flex justify-between border-b border-gray-200 pb-2">
                ...
                <span className="font-raleway text-black">Cuenta Ahorro</span>
              </div>
              <div className="flex justify-between border-b border-gray-200 pb-2">
          ...
          {/* WhatsApp CTA */}
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg p-6 mt-6 animate-fade-in-up" style={{ animationDelay: "0.45s" }}>
            <div className="text-center mb-4">
              <p className="font-raleway text-sm text-gray-700 mb-3">
                <strong className="text-green-800">¿Ya realizaste tu pago?</strong>
              </p>
              <p className="font-raleway text-xs text-gray-600 mb-4">
                Envíanos tu comprobante de pago por WhatsApp para confirmación inmediata y asignación de tus números
              </p>
            </div>

            <a
              href={`https://wa.me/593980212915?text=Hola,%20acabo%20de%20realizar%20mi%20compra.%20Mi%20referencia%20es:%20${getOrderReference(order.orderNumber)}`}
              target="_blank"
